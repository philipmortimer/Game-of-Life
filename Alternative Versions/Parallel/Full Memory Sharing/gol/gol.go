...
// GolRun starts the processing of Game of Life. It should initialise channels and goroutines.
func GolRun(p Params, events *EventHandler, keyPresses *KeyHandler) {
